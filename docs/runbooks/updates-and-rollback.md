...
No 0065 introduction SHA is approved yet. Treat any future capability-manifest schema or authority change as incompatible until its exact migration commit and additive contract version are reviewed; do not reuse the 0064 identifier or infer compatibility from migration presence alone.
