...
- inactivity templates v2: open episode UUID and policy version; canonical current consent, activity, pause, coherent non-future stage markers, and learner/administrator recipient policy are checked.
